"""
YOLOv8-Nano Training Pipeline — Pharmaceutical Blister Pack Defect Detection
==============================================================================
Dataset : Roboflow  ·  phong-tran-tuan / phong-yiyms  ·  607 images
Classes : defect, blister, capsule, no_pill
...
ROBOFLOW_WORKSPACE = "sanvis-workspace-21y5i"
ROBOFLOW_PROJECT  = "blister-8mzoc"
ROBOFLOW_VERSION  = 1                     # 1497 images (augmented), 640x640

TRAIN_EPOCHS   = 50
IMAGE_SIZE     = 640
BATCH_SIZE     = 4       # 4GB VRAM on RTX 3050
DEVICE         = "0"     # NVIDIA GeForce RTX 3050 Laptop GPU
PATIENCE       = 10      # early-stopping patience
PROJECT_DIR    = "C:/temp/pharma_defect"  # outside OneDrive to avoid file locks
RUN_NAME       = "yolov8n_blister"
...
def run_inference(model, source: str | None = None):
    ...
    if source is None:
        # Default: use the first image in the validation set
...
def main():
    parser = argparse.ArgumentParser(
        description="YOLOv8-Nano — Pharma Blister Pack Defect Detection"
    )
    parser.add_argument(
    ...
    if args.data_yaml:
        ...
        # Try the default Roboflow download path
